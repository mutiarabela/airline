...
public class UserController {
    ...
    public ResponseEntity getUser(@PathVariable String idUser){
        UserRest returnValue = userService.getUser(idUser);
        if (returnValue != null) {
    ...
    public ResponseEntity<UserRest> updatePhoneNumUser(@PathVariable String idUser, @Valid @RequestBody UserDetailsRequestModel userDetails){
        UserRest returnValue = userService.updatePhoneNumUser(idUser, userDetails);
        if (returnValue != null) {
            return new ResponseEntity<>(returnValue, HttpStatus.OK);
        } else {
    ...
    public ResponseEntity deleteUser(@PathVariable String idUser){
        UserRest returnValue = userService.deleteUser(idUser);
        if (returnValue != null) {
            return new ResponseEntity<>(returnValue, HttpStatus.OK);
        } else {
